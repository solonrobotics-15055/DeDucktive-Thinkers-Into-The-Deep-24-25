...
@Autonomous (name = "ahhgyattomous3", group = "Robot")
public class ahhgyattomous3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) //This can be if. This segment of code does not loop
        {
            disTelem();
